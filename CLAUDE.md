...
Each zip contains: the launcher, a platform-specific `ReadMe.txt`, and `app/` holding the binary plus a `version.txt` (the tag, e.g. `v5.0.1`) used to seed the installed-version marker.
